...
//Definición de los tipos de variables que se necesitan.
...
uint8_t WriteTxPower[] = {0x00, 0x01, CMD_WRITE,0x10, 0x0a, 0x0F}; //-17dbm
...
uint8_t SendHello[] = {0x00, 0x1a, CMD_WRITE, 0x2f, 0x06, 0x30, 0x39, 0x30, 0x30, 0xfd, 0x00, 0x7d, 0x03, 0x7d, 0x03, 0x7d, 0x03, 0x00, 0x00, 0x00, 0x00, 0x0a, 0x2e, 0x00, 0x34, 0x48, 0x65, 0x6c, 0x6c, 0x6f, 0x21};
uint8_t ReadIp[] = {0x00, 0x00, CMD_READ, 0x20, 0x31};
uint8_t WriteIP[] = {0x00, 0x10, CMD_WRITE, 0x20, 0x86, 0xfd, 0x00, 0x7d, 0x03, 0x7d, 0x03, 0x7d, 0x03, 0x00, 0x00, 0x00, 0x00, 0x0a, 0x2e, 0x00, 0x40};
uint8_t JoinPort[] = {0x00, 0x02, CMD_WRITE,0x21, 0x00, 0x30, 0x39};

uint8_t OOB[] = {0x00, 0x00, CMD_WRITE, 0x24,0x34}; 
uint8_t WritePANID[] = {0x00, 0x02, CMD_WRITE, 0x11, 0x25, 0x12, 0x34};
uint8_t WriteNetName[] = {0x00,0x09, CMD_WRITE, 0x14, 0x67, 0x4d, 0x79, 0x4e, 0x65, 0x74,0x77, 0x6f, 0x72, 0x6b};
uint8_t WriteMLocPref[] = {0x00, 0x08, CMD_WRITE, 0x1c, 0x89,0xfd, 0x12, 0x34, 0x00,0x38, 0x00, 0x00, 0x00, 0x00};
uint8_t WriteMK[] = {0x00, 0x10, CMD_WRITE, 0x15, 0x15,0x00, 0x11, 0x22, 0x33, 0x44, 0x55, 0x66, 0x77, 0x88, 0x99, 0xaa, 0xbb, 0xcc, 0xdd, 0xee, 0xff};
uint8_t WriteExtPID[] = {0x00, 0x08, CMD_WRITE, 0x13, 0x83,0x11, 0x22, 0x33, 0x44, 0x55, 0x66, 0x77, 0x88};
uint8_t WriteComCred[] = {0x00, 0x0b, CMD_WRITE, 0x16, 0x07, 0x4d, 0x79,0x50, 0x61, 0x73, 0x73,0x77, 0x6f, 0x72, 0x64,0x64};
uint8_t Role[] = {0x00, 0x01, CMD_WRITE, 0x19, 0x09, 0x06};
