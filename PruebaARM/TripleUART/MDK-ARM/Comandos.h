...
uint8_t PanID[] = {0x00, 0x02, CMD_WRITE, 0x11, 0x25, 0x12, 0x34}; // PAN ID = 0x1234
uint8_t NetName[] = {0x00,0x09, CMD_WRITE, 0x14, 0x67, 0x4d, 0x79, 0x4e, 0x65, 0x74,0x77, 0x6f, 0x72, 0x6b};
uint8_t MeshLocPrefix[] = {0x00, 0x08, CMD_WRITE, 0x1c, 0x89, 0xfd, 0x12, 0x34, 0,56, 0x00, 0x00, 0x00, 0x00};
uint8_t MasterKey[] = {0x00, 0x10, CMD_WRITE, 0x15, 0x15, 0x00, 0x11, 0x22, 0x33, 0x44, 0x55, 0x66, 0x77, 0x88, 0x99, 0xaa, 0xbb, 0xcc, 0xdd, 0xee, 0xff};
uint8_t ExtendPanID[] = {0x00, 0x08, CMD_WRITE, 0x13, 0x83, 0x11, 0x22, 0x33, 0x44, 0x55, 0x66, 0x77, 0x88};
uint8_t ComCred[] = {0x00, 0x0a, CMD_WRITE, 0x16, 0x07,0x4d, 0x79,0x50, 0x61, 0x73, 0x73,0x77, 0x6f, 0x72, 0x64};
...
uint8_t RoleFed[] = {0x00, 0x01, CMD_WRITE, 25, 0x0B, 0x04}; //FED, look the table below and change the last uint8_t
