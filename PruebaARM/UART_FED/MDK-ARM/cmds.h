 ...
 *
 */
void cmds_send( uint8_t typ, uint8_t cmd, uint8_t *pld, uint16_t pldLen,UART_HandleTypeDef huart1 );
 ...
 */
int16_t cmds_recv( UART_HandleTypeDef huart1 );
...
void cmds_send(uint8_t typ, uint8_t cmd, uint8_t *pld, uint16_t pldLen, UART_HandleTypeDef huart1)
{
	...
	cmds_tx_buf.frame_s.len = pldLen;
